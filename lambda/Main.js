...
var $author$project$Main$input = _Platform_incomingPort('input', $elm$json$Json$Decode$string);
...
var $author$project$Main$main = $elm$core$Platform$worker(
	{
		...
		subscriptions: function (model) {
			return $author$project$Main$input($author$project$Main$Incoming);
		},
		update: F2(
			function (msg, model) {
				var arg = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{input: arg}),
					$author$project$Main$output(arg));
			})
	});
